...
- [`비정상 가격 추적 (캔들)`](./pinescript/%EB%B9%84%EC%A0%95%EC%83%81%20%EA%B0%80%EA%B2%A9%20%EC%B6%94%EC%A0%81%20(%EC%BA%94%EB%93%A4)/README.md): 비정상 캔들, 다이버전스, ATR 배경을 함께 보는 메인 오버레이로, ATR 배경은 봉중에도 반응합니다
