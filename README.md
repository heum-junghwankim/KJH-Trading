...
- [비정상 가격 추적 (하이칸아시)](./pinescript/%EB%B9%84%EC%A0%95%EC%83%81%20%EA%B0%80%EA%B2%A9%20%EC%B6%94%EC%A0%81%20(%ED%95%98%EC%9D%B4%EC%B9%B8%EC%95%84%EC%8B%9C)/README.md)
...
- [삼중 스토캐스틱 파동 추적](./pinescript/%EC%82%BC%EC%A4%91%20%EC%8A%A4%ED%86%A0%EC%BA%90%EC%8A%A4%ED%8B%B1/README.md)
...
- [`비정상 가격 추적 (캔들)`](./pinescript/%EB%B9%84%EC%A0%95%EC%83%81%20%EA%B0%80%EA%B2%A9%20%EC%B6%94%EC%A0%81%20(%EC%BA%94%EB%93%A4)/README.md): 비정상 캔들, 다이버전스, ATR 배경, 기준 봉/후보, 스윕, 리포트를 봉 마감 기준으로 함께 보는 메인 오버레이
- [`비정상 가격 추적 (하이칸아시)`](./pinescript/%EB%B9%84%EC%A0%95%EC%83%81%20%EA%B0%80%EA%B2%A9%20%EC%B6%94%EC%A0%81%20(%ED%95%98%EC%9D%B4%EC%B9%B8%EC%95%84%EC%8B%9C)/README.md): 같은 0~4단계 흐름을 하이칸아시 가격으로 다시 계산하는 변형 오버레이
...
- [`삼중 스토캐스틱 파동 추적`](./pinescript/%EC%82%BC%EC%A4%91%20%EC%8A%A4%ED%86%A0%EC%BA%90%EC%8A%A4%ED%8B%B1/README.md): 큰 방향, 중간 조정, 단기 타점을 한 번에 정리하는 파동 보조지표
...
2. 필요하면 각 지표별 README로 들어가 설정과 해석 방법을 확인합니다. `Auto VWAP`은 평균 단가 기준을, `비정상 가격 추적 (캔들)`과 `비정상 가격 추적 (하이칸아시)`는 자리와 리포트를, `삼중 스토캐스틱`은 파동 정렬과 타점을, 거래량/MACD/보조 지표는 후속 확인을 담당합니다.
