...
class V(FPDF):
    ...
    def p_candle_basics(self):
        ...
        self._ctxt(ny2 + 3, "비정상 캔들 = 감시 시작 신호 (기준 봉 신호 아님!)", 9, True, (140, 90, 0))
    ...
    def p_signals_and_stages(self):
        ...
        signals = [
            ...
            ("④ 기준 봉", "첫 기준 신호", "entry", (240, 245, 255), (0, 120, 0)),
        ...
        self._txt(bx + sw * 2 + 8, zy + 2, "기준/후보 검토 가능", 7, True, (0, 120, 0))
